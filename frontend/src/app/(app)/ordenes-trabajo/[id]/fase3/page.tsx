...
useEffect(() => {
  (async () => {
    try {
      ...
      // ✅ Mapeo SIN tocar props inexistentes
      ...
      // Empleados (técnicos / certificadores)
      const empleados = (data.empleadosAsignados ?? []) as EmpleadoAsignadoExtendido[];
...
return (
  ...
  onChange={(e) => {
    ...
    if (!v) setDanosPrevios(''); // limpia si se apaga
  }}
/>
