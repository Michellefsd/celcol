...
// Configurar Prisma para registrar consultas y errores
// Esto es útil para depuración y monitoreo
...
// ❗️ Express 5: usar RegExp para preflight en lugar de '*'
...
app.get('/me', requireAuth, (req, res) => {
  res.json({ sub: req.user.sub, email: req.user.email, name: req.user.name, roles: req.user.roles || [] });
});
...
const ALLOWED_ORIGINS = [FRONT_ORIGIN, 'http://127.0.0.1:3000'];
